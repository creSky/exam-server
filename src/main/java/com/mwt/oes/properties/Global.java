...
package com.mwt.oes.properties;
...
public class Global {
	 ...
	 * 当前对象实例
	 */
	private static com.mwt.oes.properties.Global global =
			new com.mwt.oes.properties.Global();
	 ...
	 * 获取当前对象实例
	 */
	public static com.mwt.oes.properties.Global getInstance() {
		return global;
	}
