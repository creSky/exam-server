...
public class TeacherBankManageController {
    ...
    public ServerResponse insertSingleInfo
    ...
    public ServerResponse updateSingleInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertSingleList
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse getDorpList() {
        Map<String, Object> map = new HashMap<>();
        List<Map<String, Object>> langOptions = teacherPaperService.getLangOptions();
        map.put("langOptions", langOptions);
        return ServerResponse.createBySuccess("获取下拉信息成功", map);
    }


    //    获取搜索多选题信息
    @RequestMapping("/searchMultipleList")
    public ServerResponse searchMultipleList
    ...
    public ServerResponse deleteMultiple
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertMultipleInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse updateMultipleInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertMultipleList
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse searchJudgeList(@RequestParam("content") String
                                                  content,
                                          @RequestParam("langId") Integer langId,
                                          @RequestParam("composeFlag") String composeFlag) {
    ...
    public ServerResponse deleteJudge
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertJudgeInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse updateJudgeInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertJudgeList
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse searchFillList(@RequestParam("content") String
                                                 content,
                                         @RequestParam("langId") Integer langId,
                                         @RequestParam("composeFlag") String composeFlag) {
    ...
    public ServerResponse deleteFill
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse insertFillInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse updateFillInfo
    (@RequestBody Map<String, Object> obj) {
    ...
    public ServerResponse inserFillList
    (@RequestBody Map<String, Object> obj) {
    ...
    //    获取搜索填空题信息
    @RequestMapping("/searchAnswerList")
    public ServerResponse searchAnswerList(@RequestParam("content") String
                                                 content,
                                         @RequestParam("langId") Integer langId,
                                         @RequestParam("composeFlag") String composeFlag) {
        List<Map<String, Object>> resultList = teacherBankManageService.searchAnswerList(content, langId, composeFlag);
        return ServerResponse.createBySuccess("获取搜索简答题信息成功", resultList);
    }

    //  删除填空题
    @RequestMapping(value = "/deleteAnswer", method = RequestMethod.POST)
    public ServerResponse deleteAnswer
    (@RequestBody Map<String, Object> obj) {
        int fillId = (int) obj.get("fillId");
        int result = teacherBankManageService.deleteAnswer(fillId);
        if (result > 0) {
            return ServerResponse.createBySuccess("删除成功", null);
        } else {
            return ServerResponse.createByError("数据库错误，删除失败");
    ...
    // 添加填空题题目
    @RequestMapping(value = "/insertAnswerInfo", method = RequestMethod.POST)
    public ServerResponse insertAnswerInfo
    (@RequestBody Map<String, Object> obj) {
        int result = teacherBankManageService.insertAnswerInfo(obj);
        if (result > 0) {
            return ServerResponse.createBySuccess("添加成功", result);
        } else {
            return ServerResponse.createByError("数据库错误，添加失败");
    ...
    public ServerResponse updateAnswerInfo
    (@RequestBody Map<String, Object> obj) {
        int result = teacherBankManageService.updateAnswerInfo(obj);
        if (result > 0) {
            return ServerResponse.createBySuccess("更新成功", result);
        } else {
            return ServerResponse.createByError("数据库错误，更新失败");
    ...
    // 添加导入填空题Excel文件
    @RequestMapping(value = "/inserAnswerList", method = RequestMethod.POST)
    public ServerResponse inserAnswerList
    (@RequestBody Map<String, Object> obj) {
        List<Map<String, Object>> fillList = (List<Map<String, Object>>) obj.get("fillList");
        int result = teacherBankManageService.inserAnswerList(fillList);
        return ServerResponse.createBySuccess("文件上传成功", result);
    }
